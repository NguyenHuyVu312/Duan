...
public class DataProviderWithExcel_001 {
	...
	public void suiteSetUp() {
		...
		try {
			...
			driver.get("http://localhost:8080/Ps20704__nguyenhuyvu_asm/views/dangnhap");
...
//	}
	...
	public Object[][] Authentication() throws Exception {
		Object[][] testObjArray = ExcelUtils.getTableArray("D:\\Java4\\Ps20704__nguyenhuyvu_asm\\TestDataLogin.xlsx", "Sheet1");
		return (testObjArray);
