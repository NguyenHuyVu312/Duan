				...
				<div class="row">
					<div class="col-md-10 offset-md-1">
						<h3 class="alert alert-info">
							Category List <a href="/admin/category/form"
								...
								<c:forEach var="item" items="${page.content}">
									<tr>
										...
										<td><a class='btn btn-warning btn-xs'
											style="font-size: 14px" href="/admin/category/edit/${item.id}"> <span
						...
						<div class="d-grid gap-2 d-md-flex justify-content-md-center mt-4">
							<a class="btn btn-success" href="/admin/category?p=0">First</a> <a
								class="btn btn-success" href="/admin/category?p=${page.number-1}">Previous</a>
							<a class="btn btn-success" href="/admin/category?p=${page.number+1}">Next</a>
							<a class="btn btn-success"
								href="/admin/categoryt?p=${page.totalPages-1}">Last</a>
						</div>
						<hr />
					</div>
				</div>
